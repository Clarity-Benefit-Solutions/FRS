...
{
    public partial class TableEdit_JUL2022 : System.Web.UI.Page
    {

        #region parameter
        string tablename = System.Web.Configuration.WebConfigurationManager.AppSettings["table_jul"].ToString();
        //string viewname = System.Web.Configuration.WebConfigurationManager.AppSettings["view_query_MAY"].ToString();

        int thisMonth = 07;
        int thisyear = 2022;
        string returnurl = "TableEdit_AUG2022.aspx";
        string updatequery = "UPDATE [dbo].[ReportSettings] SET Flag = 1 WHERE [MONTH] = 'JUL' AND [YEAR] = 2022";
