<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeBehind="TableEdit_DEC2022.aspx.cs" Inherits="FRS_File_App.TableEdit_DEC2022" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server"
        ...
        SelectCommand="SELECT MEMBER_ID, FIRST, LAST, SSN, BILLING_START_DATE, BILLING_FREQUENCY, ENROLLED_PLANS, COVERAGE_LEVEL, STATUS, PREMIUM_DATE, BILLING_TYPE,
                ...
                FROM [dbo].[export_DEC2022] ORDER BY FIRST"
        UpdateCommand="UPDATE [dbo].[export_DEC2022] SET CURRENT_DUE = @CURRENT_DUE WHERE (ID = @ID)"
        DeleteCommand="DELETE FROM  [dbo].[export_DEC2022]  WHERE (ID = @ID)">
        <UpdateParameters>
