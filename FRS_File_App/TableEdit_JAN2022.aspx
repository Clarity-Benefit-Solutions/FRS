<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeBehind="TableEdit_JAN2022.aspx.cs" Inherits="FRS_File_App.WebForm2" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row">
        ...
        <div class="col-sm-10">
            ...
            <dx:ASPxGridView ID="grid_view" runat="server" Width="100%" Theme="Moderno" AutoGenerateColumns="False" DataSourceID="datasource_grid" OnRowCommand="ASPxGridView1_OnRowCommand">
            ...
            <asp:SqlDataSource ID="datasource_grid" runat="server" ConnectionString="<%$ ConnectionStrings:FRS_Pen_ReductionConnectionString %>" SelectCommand="SELECT [FIRST], [LAST], [PREMIUM_DATE], [MEMBER_ID], [SSN], [BILLING_START_DATE], [BILLING_FREQUENCY], [ENROLLED_PLANS], [COVERAGE_LEVEL], [STATUS], [PLAN_CATEGORY], [BILLING_TYPE], [ACCOUNT_TYPE], [RATE_TYPE], [END_DATE], [UnallocatedAmount], [MemberOwes], [AMOUNT], [CURRENT_DUE], [LIFE], [MEDICAL], [FLAG] FROM [export_JAN2022] ORDER BY [FIRST]"></asp:SqlDataSource>
