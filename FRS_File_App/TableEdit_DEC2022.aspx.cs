...
{
    public partial class TableEdit_DEC2022 : System.Web.UI.Page
    {
        #region parameter
        ...
        int thisMonth = 12;
        int thisyear = 2022;
        string returnurl = "TableEdit_JAN2023.aspx";
        string updatequery = "UPDATE [dbo].[ReportSettings] SET Flag = 1 WHERE [MONTH] = 'DEC' AND [YEAR] = 2022";
