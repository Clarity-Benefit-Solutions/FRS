...
{
    public partial class TableEdit_NOV2022 : System.Web.UI.Page
    {
        #region parameter
        string tablename = System.Web.Configuration.WebConfigurationManager.AppSettings["table_nov"].ToString();
        //string viewname = System.Web.Configuration.WebConfigurationManager.AppSettings["view_query_MAY"].ToString();

        int thisMonth = 11;
        int thisyear = 2022;
        string returnurl = "TableEdit_DEC2022.aspx";
        string updatequery = "UPDATE [dbo].[ReportSettings] SET Flag = 1 WHERE [MONTH] = 'NOV' AND [YEAR] = 2022";
