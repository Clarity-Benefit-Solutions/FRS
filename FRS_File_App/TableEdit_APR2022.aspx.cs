...
{
    public partial class TableEdit_APR2022 : System.Web.UI.Page
    {


        #region parameter
        string tablename = System.Web.Configuration.WebConfigurationManager.AppSettings["table_apr"].ToString();
        string viewname = System.Web.Configuration.WebConfigurationManager.AppSettings["view_query_APR"].ToString();
        int lastMonth = 02;
        int thisMonth = 04;
        int thisyear = 2022;
        string returnurl = "TableEdit_MAY2022.aspx";
        string updatequery = "UPDATE [dbo].[ReportSettings] SET Flag = 1 WHERE [MONTH] = 'APR' AND [YEAR] = 2022";
