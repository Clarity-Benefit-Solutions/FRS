...
{
    public partial class TableEdit_MAY2022 : System.Web.UI.Page
    {


        #region parameter
        string tablename = System.Web.Configuration.WebConfigurationManager.AppSettings["table_may"].ToString();
        //string viewname = System.Web.Configuration.WebConfigurationManager.AppSettings["view_query_MAY"].ToString();
        int lastMonth = 02;
        int thisMonth = 05;
        int thisyear = 2022;
        string returnurl = "TableEdit_JUN2022.aspx";
        string updatequery = "UPDATE [dbo].[ReportSettings] SET Flag = 1 WHERE [MONTH] = 'MAY' AND [YEAR] = 2022";
