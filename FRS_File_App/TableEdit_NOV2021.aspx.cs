...
{
    public partial class TableEdit_NOV2021 : System.Web.UI.Page
    {
        string tablename = System.Web.Configuration.WebConfigurationManager.AppSettings["edit_table_Nov2021"].ToString();
        string viewname = System.Web.Configuration.WebConfigurationManager.AppSettings["view_query"].ToString();
        ...
        protected void ASPxGridView1_CustomCallback(object sender, DevExpress.Web.ASPxGridViewCustomCallbackEventArgs e)
        {
            ...
            {
                ASPxTextBox lbl_Amount_Due2 = ASPxGridView1.FindRowCellTemplateControl(i, (GridViewDataColumn)ASPxGridView1.Columns["CURRENT_DUE"], "lbl_Amount_Due2")
                    as ASPxTextBox;
                Response.Write(lbl_Amount_Due2.Text);
            }
        }
        ...
        {
            if (e.Parameters == "ChangeCurrentDue")
            {
                ASPxGridView grid = (ASPxGridView)sender;
                //object categoryID = e.Parameters;
                ASPxTextBox lbl_Amount_Due2 = (ASPxTextBox)grid.FindEditRowCellTemplateControl(((GridViewDataColumn)grid.Columns["CURRENT_DUE"]), "lbl_Amount_Due2");
                Label lbl_MEMBER_ID = (Label)grid.FindEditRowCellTemplateControl(((GridViewDataColumn)grid.Columns["MEMBER_ID"]), "lbl_MEMBER_ID");
                Label lbl_PLAN_CATEGORY = (Label)grid.FindEditRowCellTemplateControl(((GridViewDataColumn)grid.Columns["PLAN_CATEGORY"]), "lbl_PLAN_CATEGORY");
        ...
        protected void btn_archive_OnClick(object sender, EventArgs e)
        {
            ...
            Response.Redirect("TableEdit_DEC2021.aspx");
        ...
        {
            string Sql = "UPDATE [dbo].[ReportSettings] SET Flag = 1 WHERE [MONTH] = 'DEC' AND [YEAR] = 2021";
            string ConnectionString = ConfigurationManager.ConnectionStrings["FRS_Pen_ReductionConnectionString"].ConnectionString;
