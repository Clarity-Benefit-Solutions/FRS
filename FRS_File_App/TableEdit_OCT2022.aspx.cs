...
{
    public partial class TableEdit_OCT2022 : System.Web.UI.Page
    {
        #region parameter
        string tablename = System.Web.Configuration.WebConfigurationManager.AppSettings["table_oct"].ToString();
        //string viewname = System.Web.Configuration.WebConfigurationManager.AppSettings["view_query_MAY"].ToString();

        int thisMonth = 10;
        int thisyear = 2022;
        string returnurl = "TableEdit_NOV2022.aspx";
        string updatequery = "UPDATE [dbo].[ReportSettings] SET Flag = 1 WHERE [MONTH] = 'OCT' AND [YEAR] = 2022";
