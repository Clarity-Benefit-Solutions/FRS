<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeBehind="TableEdit_MAR2022.aspx.cs" Inherits="FRS_File_App.TableEdit_MAR2022" %>
...
<FilterControl AutoUpdatePosition="False"></FilterControl>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server"
                ...
                FROM [dbo].[export_MAR2022] ORDER BY FIRST"
                UpdateCommand="UPDATE [dbo].[export_MAR2022] SET CURRENT_DUE = @CURRENT_DUE WHERE (ID = @ID)"
                 DeleteCommand="DELETE FROM  [dbo].[export_MAR2022] WHERE (ID = @ID)" 
        >
                <UpdateParameters>
