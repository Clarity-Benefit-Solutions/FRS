...
{
    public partial class TableEdit_MAR2022 : System.Web.UI.Page
    {


        #region parameter
        string tablename = System.Web.Configuration.WebConfigurationManager.AppSettings["table_mar"].ToString();
        string viewname = System.Web.Configuration.WebConfigurationManager.AppSettings["view_query_MAR"].ToString();
        int lastMonth = 02;
        int thisMonth = 03;
        int thisyear = 2022;
        string returnurl = "TableEdit_APR2022.aspx";
        string updatequery = "UPDATE [dbo].[ReportSettings] SET Flag = 1 WHERE [MONTH] = 'MAR' AND [YEAR] = 2022";
