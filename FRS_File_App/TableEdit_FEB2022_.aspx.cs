...
{
    public partial class TableEdit_FEB_2022 : System.Web.UI.Page
    {
        #region parameter
        string tablename = System.Web.Configuration.WebConfigurationManager.AppSettings["table_feb"].ToString();
        string viewname = System.Web.Configuration.WebConfigurationManager.AppSettings["view_query_FEB"].ToString();
        int lastMonth = 01;
        int thisMonth = 02;
        int thisyear = 2022;
        string returnurl = "TableEdit_MAR2022.aspx";
        string updatequery = "UPDATE [dbo].[ReportSettings] SET Flag = 1 WHERE [MONTH] = 'FEB' AND [YEAR] = 2022";
        #endregion
        ...
        protected void save_all()
        {
            for (int i = 0; i < grid_view.VisibleRowCount; i++)
            {
                Label lbl_PLAN_CATEGORY =
                    grid_view.FindRowCellTemplateControl(i, null, "lbl_PLAN_CATEGORY") as Label;

                Label lbl_MEMBER_ID =
                    grid_view.FindRowCellTemplateControl(i, null, "lbl_MEMBER_ID") as Label;

                ASPxTextBox lbl_Amount_Due2 =
                    grid_view.FindRowCellTemplateControl(i, null, "lbl_Amount_Due2") as ASPxTextBox;
        ...
        protected void ASPxGridView1_OnRowCommand(object sender, ASPxGridViewRowCommandEventArgs e)
        {
            ...
            else if (e.CommandArgs.CommandName == "edit")
            {
                ...
                ASPxTextBox lbl_Amount_Due2 = grid_view.FindRowCellTemplateControl(e.VisibleIndex, null, "lbl_Amount_Due2") as ASPxTextBox;
                Label lbl_PLAN_CATEGORY = grid_view.FindRowCellTemplateControl(e.VisibleIndex, null, "lbl_PLAN_CATEGORY") as Label;
